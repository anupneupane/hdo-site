// EDITS: norwegian join word + labels
...
function(module) {
	...
	Timespan.prototype.toString = function() {
		...
		if (count > 1) {
			label[count-1] = 'og '+label[count-1];
		}
		return label.join(' ');
	};
	...
	var resetLabels = countdown.resetLabels = function() {
		LABELS_SINGLUAR = 'millisekund|sekund|minutt|time|dag|uke|måned|år|tiår|århundre|årtusen'.split('|');
		LABELS_PLURAL = 'millisekunder|sekunder|minutter|timer|dager|uker|måneder|år|tiår|århundrer|årtusener'.split('|');
	};
